...
public:
	...
	void init() {
		message[MAKE_ROOM_FOR_WRITE] = "MAKE_ROOM_FOR_WRITE";
        message[SLEEP_FOR_MICROS] = "SLEEP_FOR_MICROS";
        message[WAIT_MEMTABLE_FLUSH] = "WAIT_MEMTABLE_FLUSH";
        message[WAIT_L0_FLUSH] = "WAIT_L0_FLUSH";
